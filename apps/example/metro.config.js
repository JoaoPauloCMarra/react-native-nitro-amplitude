 ...
 *
 * NOTE: Users installing react-native-nitro-amplitude from npm do NOT need
...
config.resolver.resolveRequest = (context, moduleName, platform) => {
  if (platform === "web") {
    ...
    if (moduleName === "react-native-nitro-amplitude") {
      return context.resolveRequest(
        context,
        path.resolve(
          monorepoRoot,
          "packages/react-native-nitro-amplitude/src/index.web.ts",
        ),
        platform,
      );
    }
